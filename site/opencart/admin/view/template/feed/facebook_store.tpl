  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" onclick="save('save')" form="form-google-sitemap" data-toggle="tooltip" title="" class="button btn-success" data-original-title="Save"><i class="fa fa-check"></i></button>
        <button type="submit" form="form-google-sitemap" data-toggle="tooltip" title="" class="button btn-default" data-original-title="Save & Close"><i class="fa fa-save text-success"></i></button>
        <a href="<?php echo $cancel; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>" class="button btn-default"><i class="fa fa-times-circle text-danger"></i></a></div>
                    ...
                    <div class="tab-pane" id="tab-products">
                      <div id="search" class="input-group">
                        ...
                        <span class="input-group-btn">
                          <button type="button" disabled class="button btn-default btn-lg"><i class="fa fa-search"></i></button>
                        </span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="mblock ui-draggable ui-draggable-handle" data-code="<?php echo $feed['code'] . '-' . $feed['id'] ; ?>">
                      ...
                      <div class="mblock-control-menu ui-sortable-handle">
                        <div class="mblock-action pull-right">
                          <a class="button btn-xs btn-remove" onclick="confirm('<?php echo $text_remove_feed; ?>') ? removeFeed($(this)):false;"><i class="fa fa-trash-o"></i></a>
                        </div>
                      </div>
