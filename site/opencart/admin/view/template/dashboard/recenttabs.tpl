        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tr>
              ...
              <td class="text-right">
                <a href="<?php echo $order['view']; ?>" data-toggle="tooltip" title="<?php echo $button_view; ?>" class="button btn-success">
                  <i class="fa fa-eye"></i>
                </a></td>
            </tr>
            <?php } ?>
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tr>
              ...
              <td class="text-right">
                <a href="<?php echo $_bestseller['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="button btn-success">
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tr>
              ...
              <td class="text-right">
                <a href="<?php echo $_lessseller['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="button btn-success">
                  <i class="fa fa-edit"></i>
                </a>
              </td>
            </tr>
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tr>
              ...
              <td class="text-right">
                <a href="<?php echo $_viewed['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="button btn-success">
                  <i class="fa fa-edit"></i>
                </a>
              </td>
            </tr>
