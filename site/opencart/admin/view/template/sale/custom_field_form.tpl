  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-custom-field" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="button button-primary"><i class="fa fa-save"></i></button>
          ...
          <table id="custom-field-value" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr id="custom-field-value-row<?php echo $custom_field_value_row; ?>">
                ...
                <td class="text-left"><button onclick="$('#custom-field-value-row<?php echo $custom_field_value_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="button btn-danger"><i class="fa fa-minus-circle"></i></button></td>
              </tr>
            ...
            <tfoot>
              <tr>
                <td colspan="2"></td>
                <td class="text-left"><button type="button" onclick="addCustomFieldValue();" data-toggle="tooltip" title="<?php echo $button_custom_field_value_add; ?>" class="button button-primary"><i class="fa fa-plus-circle"></i></button></td>
              </tr>
            </tfoot>
          </table>
        </form>
...
$('select[name=\'type\']').on('change', function() {
	...
	if (this.value == 'date') {
		...
		$('#display-value > div').html('<div class="input-group time"><input type="text" name="value" value="' + $('#input-value').val() + '" placeholder="<?php echo $entry_value; ?>" data-date-format="HH:mm" id="input-value" class="form-control" /><span class="input-group-btn"><button type="button" class="button btn-default"><i class="fa fa-calendar"></i></button></span></div>');
...
function addCustomFieldValue() {
	...
	html += '  <td class="text-left"><button type="button" onclick="$(\'#custom-field-value-row' + custom_field_value_row + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="button btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
	html += '</tr>';	
