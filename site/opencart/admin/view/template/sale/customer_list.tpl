...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn button-primary"><i class="fa fa-plus"></i></a>
        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-3">
              ...
              <button type="button" id="button-filter" class="btn button-primary pull-right"><i class="fa fa-search"></i> <?php echo $button_filter; ?></button>
            </div>
          </div>
        </div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php if ($customer['approve']) { ?>
                    ...
                    <?php } ?>
                    <a href="<?php echo $customer['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn button-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
