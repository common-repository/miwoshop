            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-right"><?php if ($customer['customer_id']) { ?>
                  <a href="<?php echo $customer['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="button button-primary"><i class="fa fa-pencil"></i></a></td>
                <?php } else { ?>
                <button type="button" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="button button-primary" disabled="disabled"><i class="fa fa-pencil"></i></button>
                <?php } ?>
              </tr>
              <?php } ?>
              <?php } else { ?>
