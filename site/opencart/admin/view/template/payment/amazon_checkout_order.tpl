...
<p>
  <button type="button" id="button-upload" data-loading-text="<?php echo $text_loading; ?>" class="button button-primary"><i class="fa fa-upload"></i> <?php echo $text_upload; ?></button>
</p>
<table class="table table-bordered">
  <thead>
    <tr>
