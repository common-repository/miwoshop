...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"> <a href="<?php echo $cancel; ?>" class="button button-primary"><i class="fa fa-reply"></i> <?php echo $button_cancel; ?></a> </div>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
          ...
          <div class="pull-right"> <a onclick="$('#form').submit();" class="button button-primary"><?php echo $button_refund; ?></a> </div>
        </form>
      </div>
    </div>
  </div>
