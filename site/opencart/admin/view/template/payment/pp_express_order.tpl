...
<table class="table table-striped table-bordered">
  ...
  <tr>
    ...
    <td><?php echo $paypal_order['total']; ?>
      ...
      &nbsp;&nbsp; <a onclick="doVoid();" class="button paypal_capture btn button-primary" id="button-void"><?php echo $button_void; ?></a> <span class="button button-primary" id="img_loading_void" style="display:none;"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
      <?php } ?></td>
  </tr>
  <tr>
  ...
  <tr class="paypal_capture">
    ...
    <td><p>
      ...
      <p>
        ...
        <a class="button button-primary" onclick="capture();" id="button_capture"><?php echo $button_capture; ?></a> <span class="button button-primary" id="img_loading_capture" style="display:none;"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i></span> </p></td>
  </tr>
  <?php } ?>
  <tr>
