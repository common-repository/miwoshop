...
<table class="table table-striped table-bordered">
  ...
  <tr>
    ...
    <td id="capture_status"><?php if ($firstdata_order['capture_status'] == 1 ) { ?>
      ...
      <a class="button button-primary" id="button-capture"><?php echo $button_capture; ?></a> <span class="button button-primary" id="img_loading_capture" style="display:none;"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
      <?php } ?>
      <?php } ?></td>
  </tr>
  <tr>
    ...
    <td id="void_status"><?php if ($firstdata_order['void_status'] == 1) { ?>
      ...
      <a class="button button-primary" id="button-void"><?php echo $button_void; ?></a> <span class="button button-primary" id="img_loading_void" style="display:none;"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
      <?php } ?>
      <?php } ?></td>
  </tr>
  <tr>
