...
<table class="table table-striped table-bordered">
  ...
  <tr>
    ...
    <td id="capture_status"><?php if ($realex_order['capture_status'] == 1) { ?>
      ...
      <a class="button btn button-primary" id="button_capture"><?php echo $button_capture; ?></a> <span class="button button-primary" id="img_loading_capture" style="display:none;"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
      <?php } ?>
      <?php } ?></td>
  </tr>
  <tr>
