	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-securetrading-ws" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="button button-primary"><i class="fa fa-save"></i></button>
				...
				<div class="tab-pane" id="tab-myst">
					<div class="well">
						<form id="transaction-form">
							...
							<div class="row">
								<div class="col-sm-12">
									<a class="button button-primary" onclick="showTransactions()"><?php echo $button_show ?></a>
									<a class="button button-primary" onclick="downloadTransactions()"><?php echo $button_download ?></a>
								</div>
							</div>
						</form>
					</div>
