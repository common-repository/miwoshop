...
<table class="table table-striped table-bordered">
  ...
  <tr>
    ...
    <td><?php echo $paypal_order['total']; ?>
      ...
      &nbsp;&nbsp; <a onclick="doVoid();" id="button-void" class="button paypal_capture btn button-primary"><?php echo $button_void; ?></a> <span class="button button-primary" id="img_loading_void" style="display:none;"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
      <?php } ?></td>
  </tr>
  <tr>
  ...
  <tr class="paypal_capture">
    ...
    <td><p>
      ...
      <p>
        ...
        <a class="button button-primary" onclick="capture();" id="button-capture"><?php echo $button_capture; ?></a> <span class="button button-primary" id="img_loading_capture" style="display:none;"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i></span> </p></td>
  </tr>
  <?php } ?>
  <?php if ($paypal_order['capture_status'] != 'Complete') { ?>
  <tr>
    <td><?php echo $text_reauthorise ?></td>
    <td><a id="button-reauthorise" onclick="reauthorise()" class="button button-primary"><?php echo $button_reauthorise ?></a></td>
  </tr>
  <?php } ?>
  <tr>
...
function reauthorise() {
    $.ajax({
        ...
        beforeSend: function() {
            ...
            $('.loading').remove();
            $('#button-reauthorise').after('<span class="button button-primary loading"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>');
        },
        success: function(data) {
            $('.loading').remove();
...
function resendTransaction(element) {
    $.ajax({
        ...
        beforeSend: function() {
            $(element).hide();
            $(element).after('<span class="button button-primary loading"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>');
        },
        success: function(data) {
            $(element).show();
            $('.loading').remove();
