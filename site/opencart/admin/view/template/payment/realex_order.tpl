    ...
    <td id="capture_status">
      ...
      <?php } else { ?>
        ...
        <?php if ($realex_order['void_status'] == 0) { ?>
          ...
          <a class="button btn button-primary" id="button-capture"><?php echo $button_capture; ?></a>
          <span class="button button-primary" id="loading-capture" style="display:none;"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
        <?php } ?>
      <?php } ?>
    </td>
  </tr>
  <tr>
    ...
    <td id="void_status">
      ...
      <?php } else { ?>
        ...
        <a class="button btn button-primary" id="button-void"><?php echo $button_void; ?></a>
        <span class="button button-primary" id="loading-void" style="display:none;"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
      <?php } ?>
    </td>
  </tr>
  <tr>
    ...
    <td id="rebate_status">
      ...
      <?php } else { ?>
        ...
        <?php if ($realex_order['total_captured'] > 0 && $realex_order['void_status'] == 0) { ?>
          ...
          <a class="button btn button-primary" id="button-rebate"><?php echo $button_rebate; ?></a>
          <span class="button button-primary" id="loading-rebate" style="display:none;"><i class="fa fa-circle-o-notch fa-spin fa-lg"></i></span>
        <?php } ?>
      <?php } ?>
    </td>
  </tr>
