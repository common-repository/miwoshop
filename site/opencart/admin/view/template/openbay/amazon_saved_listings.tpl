      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="pull-right">
            ...
            <a id="button-upload" class="button button-primary"><i class="fa fa-cloud-upload fa-lg"></i> <?php echo $button_upload; ?></a>
            <?php } ?>
          </div>
        </div>
      </div>
