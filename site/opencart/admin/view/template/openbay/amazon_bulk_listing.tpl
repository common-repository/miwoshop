...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"> <a href="<?php echo $link_overview; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>" class="button btn-default"><i class="fa fa-reply"></i></a> </div>
  ...
  <div class="container-fluid">
    ...
    <div class="well">
      ...
      <div class="row">
        <div class="col-sm-12 text-right"> <a class="button button-primary" id="button-filter"><i class="fa fa-filter"></i> <?php echo $button_filter; ?></a> <a class="button button-primary" id="button-search"><i class="fa fa-search"></i> <?php echo $button_search; ?></a> </div>
      </div>
    </div>
    <form id="bulk-list-form" class="form-horizontal">
      ...
      <div class="well">
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="pull-right"> <a class="button button-primary" id="button-list"><i class="fa fa-plus-circle"></i> <?php echo $button_list; ?></a> </div>
          </div>
        </div>
      </div>
    </form>
