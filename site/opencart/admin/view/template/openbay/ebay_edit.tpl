      ...
      <div class="panel-body">
        ...
        <div class="alert alert-danger" id="form-error" style="display:none;">
          <div class="row">
            ...
            <div class="col-sm-4 text-right"><a onclick="load();" class="button button-primary"><i class="fa fa-refresh"></i> <?php echo $button_retry; ?></a></div>
          </div>
        </div>
          ...
          <div class="well">
            <div class="row">
              <div class="col-sm-12 text-right">
                <a class="button btn-danger" id="button-end-item"><i class="fa fa-minus-circle"></i> <?php echo $button_end; ?></a>
                <a class="button btn-danger" id="button-remove-link"><i class="fa fa-minus-circle"></i> <?php echo $button_remove; ?></a>
                <a class="button button-primary" href="<?php echo $view_link; ?>" target="_BLANK" data-toggle="tooltip" title="<?php echo $button_view; ?>"><i class="fa fa-external-link"></i></a>
                <a class="button button-primary" id="button-save" data-toggle="tooltip" title="<?php echo $button_save; ?>"><i class="fa fa-save"></i></a>
              </div>
            </div>
          </div>
        </div>
