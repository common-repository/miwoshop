...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $return; ?>" data-toggle="tooltip" title="<?php echo $button_back; ?>" class="button btn-default"><i class="fa fa-reply"></i></a></div>
        ...
        <div class="panel-body">
          ...
          <form id="form-ebay-import" class="form-horizontal">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10"> <a class="button button-primary" id="button-import"><?php echo $button_import; ?></a> </div>
            </div>
          </form>
        </div>
      </div>
    ...
    if (answer) {
      ...
      $.ajax({
        ...
        success: function(json) {
          $('#button-import').empty().removeClass('button-primary').addClass('btn-success').html('<?php echo $button_complete; ?>');
          alert('<?php echo $text_import_notify; ?>');
        },
        error: function (xhr, ajaxOptions, thrownError) {
          $('#button-import').empty().removeClass('button-primary').addClass('btn-danger').html('<?php echo $error_import; ?>').removeAttr('disabled');
