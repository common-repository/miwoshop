...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"> <a href="<?php echo $link_overview; ?>" data-toggle="tooltip" title="<?php echo $button_back; ?>" class="button btn-default"><i class="fa fa-reply"></i></a> </div>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <p><a href="<?php echo $link_register; ?>" class="button button-primary" target="_blank"><?php echo $button_register ?></a></p>
    </div>
    <?php } else { ?>
    <div class="row">
      <div class="col-md-4">
      ...
      <div class="col-md-8">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <div class="pull-right"> <a href="<?php echo $link_change_plan; ?>" class="button button-primary" target="_blank"><i class="fa fa-arrow-right fa-lg"></i> <?php echo $button_change_plan; ?></a> </div>
            <?php } ?>
          </div>
        </div>
      </div>
