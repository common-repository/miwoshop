            ...
            <div class="col-sm-12">
              <div class="form-group">
                <div class="input-group">
                  ...
                  <a data-toggle="tooltip" title="<?php echo $button_filter; ?>" class="button button-primary input-group-addon" onclick="$('#order-update-form').submit();"><i class="fa fa-plus-circle"></i> <?php echo $button_status; ?></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <tbody>
              <?php if ($orders) { ?>
                ...
                <tr>
                  ...
                  <td class="text-right"><a href="<?php echo $order['view']; ?>" data-toggle="tooltip" title="<?php echo $button_view; ?>" class="button btn-info"><i class="fa fa-eye"></i></a></td>
                </tr>
                <?php } ?>
              <?php } else { ?>
              <tr>
