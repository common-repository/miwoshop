  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-openbay" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="button button-primary" onclick="validateForm(); return false;"><i class="fa fa-save"></i></button>
              ...
              <div class="well">
                ...
                <div id="update-v2-box">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <button class="button button-primary" id="update-v2"><?php echo $button_update; ?></button>
                    </div>
                  </div>
                </div>
            ...
            <div class="tab-pane" id="tab-update-v1">
              ...
              <div class="well">
                ...
                <div class="form-group" id="ftp-test-row">
                  ...
                  <div class="col-sm-8">
                    <button class="button button-primary" id="ftp-test"><?php echo $button_ftp_test; ?></button>
                    <div class="button button-primary" style="display:none;" id="ftp-test-loading"><i class="fa fa-cog fa-lg fa-spin"></i></div>
                  </div>
                </div>
                <div class="form-group" style="display:none;" id="ftp-update-row">
                  ...
                  <div class="col-sm-8">
                    <button class="button button-primary" id="ftp-update-module"><?php echo $button_update; ?></button>
                    <div class="button button-primary" style="display:none;" id="ftp-update-module-loading"><i class="fa fa-cog fa-lg fa-spin"></i></div>
                  </div>
                </div>
              </div>
            </div>
            <div class="tab-pane" id="tab-update-patch">
              ...
              <div class="well">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <button class="button button-primary" id="button-patch"><?php echo $button_patch; ?></button>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="tab-pane" id="tab-setting">
          <div class="well">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <button class="button button-primary" id="button-clear-faq"><?php echo $button_clear; ?></button>
              </div>
            </div>
          </div>
        </div>
        <div class="tab-pane" id="tab-developer">
          <div class="well">
            <div class="form-group">
              ...
              <div class="col-sm-10"> <a class="button button-primary" id="button-clear-data"><?php echo $button_clear; ?></a> </div>
            </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript"><!--
  ...
  $('#button-patch').bind('click', function(e) {
    ...
    $.ajax({
      ...
      success: function() {
        $('#button-patch').empty().removeClass('button-primary').addClass('btn-success').html('<?php echo $text_complete; ?>');
  ...
  $('#button-clear-faq').bind('click', function(e) {
    ...
    $.ajax({
      ...
      dataType: 'json',
      success: function(json) {
        $('#button-clear-faq').empty().removeClass('button-primary').addClass('btn-success').html('<?php echo $text_complete; ?>');
