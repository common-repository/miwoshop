    ...
    <div class="panel-body">
            ...
            <form action="<?php echo $insert; ?>" method="post" id="add-profile-form" class="form-inline pull-right" role="form">
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <a data-toggle="tooltip" title="<?php echo $button_add; ?>" class="button button-primary input-group-addon" onclick="$('#add-profile-form').submit();"><i class="fa fa-plus-circle"></i> <?php echo $button_add; ?></a>
                </div>
              </div>
            </form>
          </div>
      ...
      <table class="table table-bordered table-hover">
        ...
        <tr>
          ...
          <td class="text-right">
            <a href="<?php echo $profile['link_edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="button button-primary"><i class="fa fa-pencil"></i></a>&nbsp;
            <a href="<?php echo $profile['link_delete']; ?>" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="button btn-danger profile-delete"><i class="fa fa-minus-circle"></i></a>
          </td>
        </tr>
        <?php } ?><?php } else { ?>
        <tr>
