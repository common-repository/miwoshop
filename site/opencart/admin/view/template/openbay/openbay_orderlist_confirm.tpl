...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"> <a href="<?php echo $cancel; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>" class="button btn-default"><i class="fa fa-reply"></i></a> </div>
  ...
  <div class="container-fluid">
    ...
    <div class="pull-right"> <a onclick="validate();" class="button button-primary"><?php echo $button_update; ?></a> </div>
  </div>
</div>
