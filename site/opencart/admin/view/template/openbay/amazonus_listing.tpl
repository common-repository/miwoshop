...
<div id="content">
  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"> <a href="<?php echo $url_return; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>" class="button btn-default"><i class="fa fa-reply"></i></a> </div>
  ...
  <div class="container-fluid">
    ...
    <div class="panel-body" id="search-container">
      ...
      <div class="well">
        <div class="row">
          ...
          <div class="col-md-1">
            <div class="form-group"> <a id="search-submit" class="button button-primary" data-toggle="tooltip" title="<?php echo $button_search; ?>"><i class="fa fa-search"></i></a> </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
      ...
      <div class="well"> <?php echo $text_not_in_catalog; ?><a href="<?php echo $url_advanced; ?>" id="create_new" class="button button-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_new; ?></a> </div>
    </div>
    ...
    <div class="panel-body" id="chosen-product" style="display:none;">
              ...
              <div class="tab-pane active" id="required-info">
                ...
                <div class="form-group required">
                  <div class="col-sm-2">
                    ...
                    <div class="row">
                      <div class="col-sm-12 text-right form-group"> <a id="button-amazon-price" class="button button-primary"><?php echo $button_amazon_price; ?></a> </div>
                    </div>
                  </div>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <div class="input-group date">
                      ...
                      <button type="button" class="button button-primary"><i class="fa fa-calendar"></i></button>
                      </span> </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="input-group date">
      ...
      <div class="well">
        <div class="row">
          <div class="col-md-12 text-right"> <a class="button button-primary" id="button-list" onclick="validateQuickListing();"><?php echo $button_list ?></a> </div>
        </div>
      </div>
    </div>
  </div>
      ...
      success: function(data) {
        if (data.error){
          ...
          $.each(data['data'], function(index, value) {
            ...
            html += '    <a target="_blank" href="' + value.link + '" class="button button-primary" data-toggle="tooltip" title="<?php echo $button_view_on_amazon ?>"><i class="fa fa-eye"></i></a>';
            html += '    <a onclick="' + functString + '" class="button button-primary" data-toggle="tooltip" title="<?php echo $text_list ?>"><i class="fa fa-check-square"></i></a>';
            html += '  </td>';
            html += '</tr>';
