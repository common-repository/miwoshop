  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <a href="<?php echo $cancel; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>" class="button btn-default" id="btn-cancel"><i class="fa fa-reply"></i></a>
      </div>
  ...
  <div class="container-fluid">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
      ...
      <div class="tab-content">
              ...
              <div class="row">
                <div class="col-sm-4">
                  <div class="row">
                    ...
                    <div class="col-xs-2">
                      <button class="button button-primary" title="" onclick="addMaterial();" data-toggle="tooltip" type="button" data-original-title="<?php echo $text_material_add; ?>"><i class="fa fa-plus-circle"></i></button>
                    </div>
                  </div>
                </div>
                <div class="col-sm-8">
              ...
              <div class="row">
                <div class="col-sm-4">
                  <div class="row">
                    ...
                    <div class="col-xs-2">
                      <button class="button button-primary" title="" onclick="addTag();" data-toggle="tooltip" type="button" data-original-title="<?php echo $text_tag_add; ?>"><i class="fa fa-plus-circle"></i></button>
                    </div>
                  </div>
                </div>
                <div class="col-sm-8">
        ...
        <div class="well">
          <div class="row">
            <div class="col-sm-12"> <a class="button button-primary pull-right" id="button-submit" onclick="submitForm();"><span><?php echo $button_submit; ?></span></a> </div>
          </div>
        </div>
      </div>
    </form>
