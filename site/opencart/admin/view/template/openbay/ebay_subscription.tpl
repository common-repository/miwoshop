  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <a href="<?php echo $return; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>" class="button btn-default"><i class="fa fa-reply"></i></a>
      </div>
  ...
  <div class="container-fluid">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="row">
          <div class="col-md-4">
            <a class="button button-primary" id="load-account" disabled="disabled"><i class="fa fa-cog fa-lg fa-spin"></i> <?php echo $text_load_my_plan; ?></a>
          ...
          <div class="col-md-8">
            <a class="button button-primary" id="load-plans" disabled="disabled"><i class="fa fa-cog fa-lg fa-spin"></i> <?php echo $text_load_plans; ?></a>
    ...
    $.ajax({
      ...
      success: function(json) {
        ...
        $.each(json.plans, function(key,val){
          ...
          if (val.myplan == 1){
            htmlInj += '<td><a class="button btn-success" disabled="disabled"><i class="fa fa-check-circle-o fa-lg"></i> <?php echo $column_current; ?></a></td>';
          }else{
            if (val.user_plan_id == 1) {
              htmlInj += '<td></td>';
            }else{
              htmlInj += '<td>';
              htmlInj += '<a href="https://uk.openbaypro.com/account/live/subscription_setup.php?plan_id='+val.user_plan_id+'&subscriber_id=<?php echo $obp_token;?>" class="button button-primary" target="_BLANK"><i class="fa fa-arrow-right fa-lg"></i> <?php echo $button_plan_change; ?></a>';
              htmlInj += '</td>';
            }
          }
          htmlInj += '</tr>';
