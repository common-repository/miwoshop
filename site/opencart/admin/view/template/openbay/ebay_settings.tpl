  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-ebay-settings" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="button button-primary" onclick="validateForm(); return false;"><i class="fa fa-save"></i></button>
          ...
          <div class="tab-pane" id="tab-setup">
            ...
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10"> <a class="button button-primary" id="button-clear-locks"><?php echo $button_clear; ?></a> </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="button-repair-links"><?php echo $button_repair_links; ?></label>
                <div class="col-sm-10"> <a class="button button-primary" id="button-repair-links"><?php echo $button_update; ?></a> </div>
              </div>
            </fieldset>
          </div>
