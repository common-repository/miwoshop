        ...
        <div class="well" style="display:none;" id="link-well">
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <a onclick="addLink();" class="button button-primary pull-right" id="button-submit-link"><i class="fa fa-check"></i> <?php echo $button_save; ?></a> </div>
          </div>
        </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-right"><?php if (in_array('activate_item', $listing['actions'])) { ?>
                  <button data-toggle="tooltip" title="<?php echo $text_activate; ?>" class="button button-primary" onclick="activateListing('<?php echo $listing['listing']['listing_id']; ?>');" id="btn-activate-<?php echo $listing['listing']['listing_id']; ?>"><i class="fa fa-plus"></i></button>
                  <?php } ?>
                  <?php if (in_array('add_link', $listing['actions'])) { ?>
                  <button data-toggle="tooltip" title="<?php echo $text_add_link; ?>" class="button button-primary" onclick="showLinkOption('<?php echo $listing['listing']['listing_id']; ?>');"><i class="fa fa-link"></i></button>
                  <?php } ?>
                  <?php if (in_array('delete_link', $listing['actions'])) { ?>
                  <button data-toggle="tooltip" title="<?php echo $text_delete_link; ?>" class="button btn-danger" id="btn-delete-<?php echo $listing['link']['etsy_listing_id']; ?>" onclick="deleteLink('<?php echo $listing['link']['etsy_listing_id']; ?>');"><i class="fa fa-unlink"></i></button>
                  <?php } ?>
                  <?php if (in_array('end_item', $listing['actions'])) { ?>
                  <button data-toggle="tooltip" title="<?php echo $text_delete; ?>" class="button btn-danger" onclick="endListing('<?php echo $listing['listing']['listing_id']; ?>');" id="btn-end-<?php echo $listing['link']['etsy_listing_id']; ?>"><i class="fa fa-times"></i></button>
                  <button data-toggle="tooltip" title="<?php echo $text_deactivate; ?>" class="button btn-danger" onclick="deactivateListing('<?php echo $listing['listing']['listing_id']; ?>');" id="btn-deactivate-<?php echo $listing['listing']['listing_id']; ?>"><i class="fa fa-ban"></i></button>
                  <?php } ?></td>
              </tr>
              <?php } ?>
              <?php } else { ?>
