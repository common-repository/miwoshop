...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <a href="<?php echo $url_remove_errors; ?>" data-toggle="tooltip" title="<?php echo $button_remove_error; ?>" class="button btn-default"><i class="fa fa-reply"></i></a>
        <?php } ?>
        <a href="<?php echo $cancel_url; ?>" data-toggle="tooltip" title="<?php echo $button_cancel; ?>" class="button btn-default"><i class="fa fa-reply"></i></a> </div>
  ...
  <div class="container-fluid">
    ...
    <div class="well">
      <div class="row">
        <div class="col-md-12 text-right"> <a class="button button-primary" data-toggle="tooltip" title="<?php echo $button_save ?>" onclick="validate_and_save('advanced')"><i class="fa fa-save fa-lg"></i></a> <a class="button button-primary" data-toggle="tooltip" title="<?php echo $button_save_upload ?>" onclick="save_and_upload()"><i class="fa fa-cloud-upload fa-lg"></i></a> <a class="button button-primary" data-toggle="tooltip" title="<?php echo $button_saved_listings ?>" href="<?php echo $saved_listings_url; ?>"><i class="fa fa-copy fa-lg"></i></a> </div>
      </div>
    </div>
  </div>
</div>
...
function show_form(xml, formType) {
    ...
    $.ajax({
        ...
        beforeSend: function() {
            ...
            $('#category_selector_label').after('<a class="button button-primary wait" disabled="disabled"><i class="fa fa-cog fa-lg fa-spin"></i> </a>');
        },
        complete: function() {
...
function nodeSelect(field, original_field) {
    ...
    $.ajax({
        ...
        dataType: 'json',
        beforeSend: function(){
          $('#browse-node-content').empty().html('<a class="button button-primary" disabled="disabled"><i class="fa fa-cog fa-lg fa-spin"></i> </a>');
        },
        success: function(data) {
          if (data.node.error != true){
            html += '<div class="row">';
            ...
            if (data.node.final == 0){
              ...
              html += '<div class="row">';
                html += '<div class="col-sm-12 text-right">';
                  html += '<a onclick="saveNode('+data.node.id+', \''+original_field+'\', \''+nodeStringSimple+'\')" class="button button-primary"><i class="fa fa-save fa-lg"></i> <?php echo $button_save; ?></a>';
                html += '</div>';
              html += '</div>';
            }
