...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <a onclick="confirmAction('<?php echo $cancel; ?>');" data-toggle="tooltip" title="<?php echo $button_cancel; ?>" class="button btn-default"><i class="fa fa-reply"></i></a>
      </div>
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
          ...
          <div class="tab-content">
            <div id="tab-listing-general" class="tab-pane active">
              ...
              <?php } ?>
              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_category_suggested; ?><br /><span id="suggested-categories-loading" style="display: none;"><a class="button btn-info" disabled="disabled"><i class="fa fa-cog fa-lg fa-spin"></i></a></span></label>
                <div class="col-sm-10">
                  <div id="suggested-cats"></div>
                </div>
              </div>
              <div class="form-group" id="category-selections-row">
                <label class="col-sm-2 control-label"><?php echo $entry_category; ?><br /><span id="category-loading" style="display: none;"><a class="button btn-info" disabled="disabled"><i class="fa fa-cog fa-lg fa-spin"></i></a></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group" id="condition-container" style="display: none;">
                <label class="col-sm-2 control-label"><?php echo $entry_listing_condition; ?><br /><span id="condition-loading" style="display: none;"><a class="button btn-info" disabled="disabled"><i class="fa fa-cog fa-lg fa-spin"></i></a></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group" id="duration-container" style="display: none;">
                <label class="col-sm-2 control-label"><?php echo $entry_listing_duration; ?><br /><span id="duration-loading" style="display: none;"><a class="button btn-info" disabled="disabled"><i class="fa fa-cog fa-lg fa-spin"></i></a></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="row">
                    ...
                    <div class="col-sm-1">
                      <a class="button button-primary" id="button-catalog-search"><i class="fa fa-search"></i> <?php echo $button_search; ?></a>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <!-- OPENSTOCK CHANGES FINSISH @TODO -->
            ...
            <div id="tab-listing-price" class="tab-pane">
              <div class="well well-lg">
                <div class="row">
                  <label class="col-sm-2 control-label"><?php echo $entry_profile_load; ?><br /><span id="profile-generic-loading" style="display: none;"><a class="button btn-info" disabled="disabled"><i class="fa fa-cog fa-lg fa-spin"></i></a></span></label>
                  <div class="col-sm-10">
                    <div class="input-group">
  ...
  <!-- OPENSTOCK CHANGES FINSISH @TODO -->
            ...
            <div id="tab-listing-shipping" class="tab-pane">
              <div class="well well-lg">
                <div class="row">
                  <label class="col-sm-2 control-label"><?php echo $entry_profile_load; ?><br /><span id="profile-shipping-loading" style="display: none;"><a class="button btn-info" disabled="disabled"><i class="fa fa-cog fa-lg fa-spin"></i></a></span></label>
                  <div class="col-sm-10">
                    <div class="input-group">
              ...
              <div id="national-container-flat" style="display:none;" class="shipping-national-container">
                <div class="form-group">
                  <div class="col-sm-2">
                    ...
                    <div class="row">
                      <div class="col-sm-12 text-right">
                        <p><a class="button button-primary" onclick="addShipping('national', 'flat');" id="add-national-flat"><i class="fa fa-plus-circle"></i> <?php echo $button_add; ?></a></p>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-10">
              ...
              <div id="national-container-calculated" style="display:none;" class="shipping-national-container">
                ...
                <div class="form-group">
                  <div class="col-sm-2">
                    ...
                    <div class="row">
                      <div class="col-sm-12 text-right">
                        <p><a class="button button-primary" onclick="addShipping('national', 'calculated');" id="add-national-calculated"><i class="fa fa-plus-circle"></i> <?php echo $button_add; ?></a></p>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-10">
              ...
              <div id="international-container-flat" style="display:none;" class="shipping-international-container">
                <div class="form-group">
                  <div class="col-sm-2">
                    ...
                    <div class="row">
                      <div class="col-sm-12 text-right">
                        <p><a class="button button-primary" onclick="addShipping('international', 'flat');" id="add-international-flat"><i class="fa fa-plus-circle"></i> <?php echo $button_add; ?></a></p>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-10">
              ...
              <div id="international-container-calculated" style="display:none;" class="shipping-international-container">
                ...
                <div class="form-group">
                  <div class="col-sm-2">
                    ...
                    <div class="row">
                      <div class="col-sm-12 text-right">
                        <p><a class="button button-primary" onclick="addShipping('international', 'calculated');" id="add-international-calculated"><i class="fa fa-plus-circle"></i> <?php echo $button_add; ?></a></p>
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-10">
            ...
            <div id="tab-listing-returns" class="tab-pane">
              <div class="well well-lg">
                <div class="row">
                  <label class="col-sm-2 control-label"><?php echo $entry_profile_load; ?><br /><span id="profile-returns-loading" style="display: none;"><a class="button btn-info" disabled="disabled"><i class="fa fa-cog fa-lg fa-spin"></i></a></span></label>
                  <div class="col-sm-10">
                    <div class="input-group">
            ...
            <div class="well">
              <div class="row">
                <div class="col-sm-12 text-right">
                  <a class="button button-primary" id="button-verify"><span><?php echo $text_verify; ?></span></a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="well">
          <div class="row">
            <div class="col-sm-6 text-left">
              <a class="button button-primary" target="_BLANK" id="button-preview" style="display:none;"><i class="fa fa-external-link fa-lg"></i> <?php echo $text_preview; ?></a>
              <a class="button button-primary" id="button-edit"><i class="fa fa-pencil fa-lg"></i> <?php echo $text_review_edit; ?></a>
            </div>
            <div class="col-sm-6 text-right">
              <a class="button button-primary" id="button-save"><i class="fa fa-save fa-lg"></i> <?php echo $button_save; ?></a>
            </div>
          </div>
        </div>
      </div>
      <div class="panel-body" style="display: none;" id="page-complete">
        ...
        <div class="well">
          <div class="row">
            <div class="col-sm-6 text-left">
              <a class="button button-primary" id="button-view" target="_BLANK"><i class="fa fa-external-link fa-lg"></i> <?php echo $button_view; ?></a>
              <a class="button button-primary" href="<?php echo $product['edit_link']; ?>"><i class="fa fa-pencil fa-lg"></i> <?php echo $button_edit; ?></a>
            </div>
            <div class="col-sm-6 text-right">
              <a class="button button-primary" href="<?php echo $cancel; ?>"><i class="fa fa-reply fa-lg"></i> <?php echo $text_return; ?></a>
            </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript"><!--
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      html += '<a onclick="removeShipping(\'' + id + '\',\'' + count + '\',\''+type+'\');" class="button btn-danger"><i class="fa fa-minus-circle"></i> <?php echo $button_delete; ?></a>';
      html += '</div>';
      html += '</div>';
      html += '</div>';
