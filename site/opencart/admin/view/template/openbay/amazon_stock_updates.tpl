  ...
  <div class="container-fluid">
    <div class="well">
      <div class="row">
        ...
        <div class="col-sm-2 text-right"> <a onclick="filter();" class="button button-primary" data-toggle="tooltip" title="<?php echo $button_filter; ?>"><i class="fa fa-filter"></i></a> </div>
      </div>
    </div>
