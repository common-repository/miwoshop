    ...
    <div class="container-fluid">
      <div class="pull-right">
        <?php if ($link_amazon_eu_bulk) { ?>
          <a class="button button-primary" href="<?php echo $link_amazon_eu_bulk; ?>"><i class="fa fa-cloud-upload fa-lg"></i> <?php echo $button_amazon_eu_bulk; ?></a>
        <?php } ?>
        <?php if ($link_amazon_us_bulk) { ?>
          <a class="button button-primary" href="<?php echo $link_amazon_us_bulk; ?>"><i class="fa fa-cloud-upload fa-lg"></i> <?php echo $button_amazon_us_bulk ?></a>
        <?php } ?>
        <?php  if ($link_ebay_bulk) { ?>
          <a class="button button-primary" id="button-ebay-bulk"><i class="fa fa-cloud-upload fa-lg"></i> <?php echo $button_ebay_bulk; ?></a>
        <?php } ?>
      </div>
        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <a onclick="filter();" class="button button-primary pull-right" data-toggle="tooltip" title="<?php echo $button_filter; ?>"><i class="fa fa-search"></i> <?php echo $button_filter; ?></a>
            </div>
          </div>
        </div>
                  ...
                  <td>
                    <?php foreach ($product['markets'] as $market) { ?>
                      <?php if ($market['status'] == 1) { ?>
                        <a href="<?php echo $market['href']; ?>" data-toggle="tooltip" title="<?php echo $market['text']; ?>" class="button btn-block btn-sm btn-success"><?php echo $market['name']; ?></a>
                      <?php } elseif ($market['status'] == 2) { ?>
                        <a href="<?php echo $market['href']; ?>" data-toggle="tooltip" title="<?php echo $market['text']; ?>" class="button btn-block btn-sm btn-danger"><?php echo $market['name']; ?></a>
                      <?php } elseif ($market['status'] == 3) { ?>
                        <?php if ($market['href'] != '') { ?>
                          <a href="<?php echo $market['href']; ?>" data-toggle="tooltip" title="<?php echo $market['text']; ?>" class="button btn-block btn-sm btn-info"><?php echo $market['name']; ?></a>
                        <?php } else { ?>
                          <a disable="disable" data-toggle="tooltip" title="<?php echo $market['text']; ?>" class="button btn-info btn-block btn-sm"><?php echo $market['name']; ?></a>
                        <?php } ?>
                      <?php } else { ?>
                        <a href="<?php echo $market['href']; ?>" data-toggle="tooltip" title="<?php echo $market['text']; ?>" class="button btn-block btn-sm btn-default"><?php echo $market['name']; ?></a>
                      <?php } ?>
                    <?php } ?>
                  </td>
                </tr>
