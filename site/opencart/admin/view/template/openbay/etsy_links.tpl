              ...
              <?php foreach ($items as $id => $item) { ?>
                <tr id="row-<?php echo $item['etsy_listing_id']; ?>">
                  ...
                  <td class="text-center"><?php if ($item['status'] == 1) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-center"><button class="button btn-danger" id="row-delete-btn-<?php echo $item['etsy_listing_id']; ?>" onclick="deleteLink('<?php echo $item['etsy_listing_id']; ?>')"><i class="fa fa-times"></i></button></td>
                </tr>
              <?php } ?>
            <?php } else { ?>
            <tr>
