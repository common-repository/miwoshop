...
class ControllerMarketingAffiliate extends Controller {
	...
	protected function getList() {
		...
		$pagination->url = $this->url->link('marketing/affiliate', 'token=' . $this->session->data['token'] . $url . '&pg={page}', 'SSL');
	...
	public function transaction() {
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('marketing/affiliate/transaction', 'token=' . $this->session->data['token'] . '&affiliate_id=' . $this->request->get['affiliate_id'] . '&pg={page}', 'SSL');
