...
class ControllerOpenbayAmazon extends Controller {
	...
	public function bulkListProducts() {
		...
		if ($bulk_listing_status) {
			...
			$pagination->url = $this->url->link('openbay/amazon/bulkListProducts', 'token=' . $this->session->data['token'] . '&pg={page}&filter_marketplace=' . $filter_marketplace, 'SSL');
