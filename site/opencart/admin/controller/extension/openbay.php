...
class ControllerExtensionOpenbay extends Controller {
	...
	public function orderList() {
		...
		$pagination->url = $this->url->link('extension/openbay/orderList', 'token=' . $this->session->data['token'] . $url . '&pg={page}', 'SSL');
	...
	public function items() {
		...
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->text = $this->language->get('text_pagination');
		$pagination->url = $this->url->link('extension/openbay/items', 'token=' . $this->session->data['token'] . $url . '&pg={page}', 'SSL');
