		...
		<div class="well">
			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<input type="submit" value="<?php echo $button_login; ?>" class="<?php echo MiwoShop::getButton(); ?>"/>
					<a href="<?php echo $register; ?>" class="<?php echo MiwoShop::getButton(); ?>"><span><?php echo $button_create; ?></span></a>
				</div>
			</form>
			<?php } else { ?>
			...
			<div style="text-align: center;border-top:1px solid #ccc;padding: 15px 0;">
				<a href="<?php echo $logout; ?>" class="<?php echo MiwoShop::getButton(); ?>"><span><?php echo $button_logout; ?></span></a>
			</div>
			<?php } ?>
		</div>
	</div>
