...
<div class="container"><?php echo $content_top; ?>
  ...
  <div class="buttons">
    <div class="pull-left">
	  <a href="<?php echo $back; ?>" class="button button-primary"><?php echo $text_back; ?></a>
    </div>
    <div class="pull-right">
      <input class="button button-primary" id="confirm-button" type="submit" value="<?php echo $text_confirm; ?>" />
    </div>
  </div>
